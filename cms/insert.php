...
//----------------------------------------------------
try {
  $pdo = new PDO('mysql:dbname=ataru_sample;charset=utf8;host=mysql57.ataru.sakura.ne.jp','ataru','3110ataru');
} catch (PDOException $e) {
  exit('DbConnectError:'.$e->getMessage());
}
$sql="INSERT INTO gs_db ( id, item, value, fname,
description, indate )
VALUES( NULL, :item, :value, :fname, :description, sysdate() )";
...
$stmt->bindValue(':value', $value, PDO::PARAM_STR); //数値
